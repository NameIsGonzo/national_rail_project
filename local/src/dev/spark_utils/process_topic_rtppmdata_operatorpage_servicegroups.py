...
def process_topic(spark: SparkSession, topic: str, kafka_host: str, kafka_port: str) -> None:
    ...
    df = (
        ...
        .select(from_json(col("value"), schema.operatorpage_serviceoperators).alias("data"))
        .select("data.*")
        .selectExpr(cast.operatorpage_serviceoperators)
